...
export const caseCategories: CaseCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: '高校自助知识服务平台——领先一步的高校AI知识中枢解决方案',
        description:
          '这是一个能融合数据、能智能服务、能任务闭环、还能安全交付的高校知识平台。通过统一门户、知识治理平台、智能体支撑底座，全面服务教研、申报、评估、管理等核心业务场景，并具备支撑智能体构建的持续演进能力。',
        picName: '某高职校DEEPSEEK-AI+知识服务应用.png',
        detailPicName: '某高职校DEEPSEEK-AI+知识服务应用.png',
        routeAdress: '/industry-cases/university-knowledge-platform',
        pointOfPain: [
          {
            title: '材料分散、重复劳动',
            description:
              '高校各部门的知识资料分散在不同系统中，申报、评估等工作需要重复收集整理材料，造成大量重复劳动，效率低下。'
          },
          {
            title: '找制度、流程麻烦',
            description:
              '师生查找学校制度、流程文件需要翻阅大量资料，难以快速获取准确信息，影响工作和学习效率。'
          },
          {
            title: '多部门数据需人工统计',
            description:
              '各部门数据分散存储，需要人工统计汇总，无法实现智能化的数据问答和图表生成，决策支持能力不足。'
          },
          {
            title: '数据安全要求高',
            description:
              '高校对数据安全要求严格，传统云端部署方案存在数据外流风险，无法满足校内数据安全合规要求。'
          },
          {
            title: '用户反馈难追踪',
            description:
              '缺乏有效的用户反馈机制，无法及时了解系统使用情况和用户满意度，系统优化和迭代缺乏数据支撑。'
          }
        ],
        solution: [
          {
            title: '统一融合能力——结构化+非结构化资源统一治理',
            description:
              '建立统一的知识门户，实现结构化和非结构化资源的统一治理和平台调用，打破信息孤岛，聚合个人/共享/广场资源，支持多模态搜索、智能问答、语义推荐。'
          },
          {
            title: 'AI实用性——自研文档大模型，支持智能问答',
            description:
              '采用自研文档大模型，支持智能问答、知识解析、结构化摘要，相比通用大模型更聚焦高校内容，提供精准的专业问答服务。'
          },
          {
            title: '任务闭环设计——教改、评估、申报等流程材料自动聚合',
            description:
              '在教学改革、评估、申报等业务流程中，可按任务聚合知识材料并支持执行，实现业务驱动的材料归集模块，提高工作效率。'
          },
          {
            title: '智能体支撑能力——可持续的知识中枢体系',
            description:
              '提供统一知识解析与任务支撑能力，支持后续教学、科研智能体任务构建，具备平台级支撑体系和持续演进能力。'
          },
          {
            title: '部署安全性——私有化交付、本地算力适配',
            description:
              '采用私有化部署方案，本地大模型一体机部署，零数据外流，支持敏感词与权限管理，满足高校数据安全合规要求。'
          },
          {
            title: '六大核心功能模块',
            description:
              '包含文档解读助手、数据解读助手、知识查阅助手、知识员工助手、材料归集模块、流程问答助手六大模块，全面覆盖高校知识服务需求。'
          }
        ],
        result: []
      }
